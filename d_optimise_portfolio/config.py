...
class Config:
    x_pred_pkl: str = '../c_gp_fit/X_pred.npy'
    y_pred_pkl: str = '../c_gp_fit/y_pred.npy'
    y_std_pkl: str = '../c_gp_fit/y_std.npy'
    price_csv: str = '../a_data/bitcoin_combined_weekly_data.csv'
