...
├── 1-log-fit/              # Log trend fitting
├── 2-gp_fit/               # Gaussian Process modeling
├── 3-optimise_portfolio/   # Portfolio optimization
...
- Python config classes in each analysis module

## Contributing

1. Make changes to Go code in `cmd/` or `internal/`
2. Update Python analysis in numbered directories
3. Run `make analysis` to update charts
